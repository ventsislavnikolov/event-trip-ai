      ...
      >
        ...
        >
          ...
          {message.parts?.map((part, index) => {
            ...
            if (type === "data-eventtripPackages") {
              const packagePart = part as {
            ...
            if (type === "data-eventtripCandidates") {
              const candidatesPart = part as {
                type: "data-eventtripCandidates";
                data: Parameters<typeof DisambiguationPicker>[0]["candidates"];
              };

              if (
                !Array.isArray(candidatesPart.data) ||
                candidatesPart.data.length === 0
              ) {
                return null;
              }
